...
<body>
    ...
    <div class="right">
        <form class="piechart" action="newsavings.php" method="post">
            <h1>New Task</h1>
            <input type="text" placeholder="Task Name" name="sname"><br>
            <input type="number" placeholder="Total hours required" name="amount"><br>
            <button type="submit">Add</button>
        </form>
        <form class="piechart" action="updatesavings.php" method="post">
            <h1>Update Task</h1>
            <input type="text" placeholder="Task Name" name="sname">
            <input type="number" placeholder="hours worked today" name="amount">
